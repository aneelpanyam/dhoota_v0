...
export function MobileBottomNav({
  ...
  return (
    <nav
      className={`fixed bottom-0 left-0 right-0 z-40 md:hidden w-full max-w-[100vw] border-t border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 pb-[env(safe-area-inset-bottom)] ${navStyles ? "[&_.text-muted-foreground]:!text-inherit [&_.text-foreground]:!text-inherit" : ""}`}
